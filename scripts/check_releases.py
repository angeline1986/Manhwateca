...
def main() -> int:
    ...
    print(f"Data mínima encontrada: {result.earliest_release_date or '-'}")
    print(f"Data máxima encontrada: {result.latest_release_date or '-'}")
    print(f"Motivo da parada: {result.stop_reason or '-'}")
